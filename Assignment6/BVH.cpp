...
Intersection BVHAccel::getIntersection(BVHBuildNode* node, const Ray& ray) const
{
    ...
    {
        float ldist = dotProduct(ray.origin - lisect.coords, ray.origin - lisect.coords);
        float rdist = dotProduct(ray.origin - risect.coords, ray.origin - risect.coords);
        return (ldist < rdist) ? lisect : risect;
    }
